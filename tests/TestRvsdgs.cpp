...
LoadTest2::SetupRvsdg()
{
  ...
  auto ld1 = LoadNode::Create(p[0], p_amp_x, *pt, 4);
  auto ld2 = LoadNode::Create(ld1[0], {ld1[1]}, jive::bit32, 4);
...
ExternalCallTest::SetupRvsdg()
{
  ...
  auto SetupFunctionF = [&](jive::argument * functionG)
  {
    ...
    auto loadPath = LoadNode::Create(allocaPath[0], storeMode, jive::bit8, 4);
    auto loadMode = LoadNode::Create(allocaMode[0], {loadPath[1]}, jive::bit8, 4);
...
DeltaTest3::SetupRvsdg()
{
    ...
    delta::output & g2)
  {
    ...
    auto loadResults = LoadNode::Create(g2CtxVar, {memoryStateArgument}, jive::bit32, 8);
